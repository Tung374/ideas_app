                        ...
                        <Modal.Body>
                            <form onSubmit={handleAddCloseDate}>
                                <div className="grid-container">
                                    ...
                                    <input className="myCustomInput item2" value={year} 
                                    onChange={(e) => setYear(e.target.value)} placeholder="Year" required type="text"/>
                                </div>
                                <div className="grid-container">
                                    <label className="myCustomlabel item1">Open Date:</label>
                                    <DatePicker required showYearDropdown scrollableYearDropdown showTimeSelect dateFormat="Pp" selected={addOpenDate} 
                                    onChange={(date) => setAddOpenDate(date)} />
                                </div>
                                <div className="grid-container">
                                    <label className="myCustomlabel item1">Comment Close Date:</label>
                                    <DatePicker required showYearDropdown scrollableYearDropdown showTimeSelect dateFormat="Pp" selected={addCommentCloseDate} 
                                    onChange={(date) => setAddCommentCloseDate(date)} />
                                </div>
                                <div className="grid-container">
                    ...
                    <Modal className="myModal" show={showUpdateModal} onHide={handleCloseUpdateForm}>
                        ...
                        <Modal.Body>
                            <form onSubmit={handleUpdateCloseDate}>
                                ...
                                <div className="grid-container">
                                    <label className="myCustomlabel item1">Post Open Date:</label>
                                    <DatePicker showYearDropdown scrollableYearDropdown showTimeSelect dateFormat="Pp" selected={newOpenDate} 
                                    onChange={(date) => setNewOpenDate(date)} />
                                </div>
                                <div className="grid-container">
                                    <label className="myCustomlabel item1">Comment Close Date:</label>
                                    <DatePicker showYearDropdown scrollableYearDropdown showTimeSelect dateFormat="Pp" selected={newCommentCloseDate} 
                                    onChange={(date) => setNewCommentCloseDate(date)} />
                                </div>
                                <div className="grid-container">
                                    <label className="myCustomlabel item1">Post Close Date:</label>
                                    <DatePicker showYearDropdown scrollableYearDropdown showTimeSelect dateFormat="Pp" selected={newPostCloseDate} 
                                    onChange={(date) => setNewPostCloseDate(date)} />
                                </div>
                                <Button className="myCustomFooterButton" type="submit" variant="primary">
                                    Update
                                </Button>
